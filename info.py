...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/RSK_MOVIEz')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'RSK_Backup')
...
URL = "https://jisshu-bot-g6qy.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://jisshu-bot-g6qy.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://jisshu-bot-g6qy.onrender.com/".format(FQDN)
else:
    URL = "https://jisshu-bot-g6qy.onrender.com/".format(FQDN)
